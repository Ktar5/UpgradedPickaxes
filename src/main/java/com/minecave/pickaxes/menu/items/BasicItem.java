 ...
 */
package com.minecave.pickaxes.menu.items;
...
public class BasicItem implements Item {
    ...
    public static ItemListener EMPTY_ITEM = (p, c) -> { };
    ...
    public static BasicItem createFiller(ItemStack stack) {
        return new BasicItem(stack, EMPTY_ITEM);
    }
}
