...
import com.minecave.pickaxes.menu.MenuFactory;
...
//
//
//    private ItemStack next = new Wool(DyeColor.GREEN).toItemStack();
//    private ItemStack back = new Wool(DyeColor.RED).toItemStack();
//
//    protected Menu[] menus;
